...
| [Deploy Sharding Service with Apache ShardingSphere on RDS for PostgreSQL](https://github.com/alibabacloud-howto/opensource_with_apsaradb/tree/main/apache-shardingsphere-postgresql) | Deploy sharding service with Apache ShardingSphere on RDS for PostgreSQL. | EIP, ECS, RDS PostgreSQL | | |
| [Setup RDS MySQL primary instance and Read-Only instance](https://github.com/alibabacloud-howto/terraform-templates/blob/master/terraform-alicloud-db-samples/rds-mysql-ro-clouddisk/main.tf) | Create and setup RDS MySQL primary instance and Read-Only instance. | RDS MySQL | | |
