...
| [Quick Path to Create RDS MySQL High Availability Primary instance and Read-Only instance](https://github.com/alibabacloud-howto/terraform-templates/blob/master/terraform-alicloud-db-samples/rds-mysql-ro) | Create and setup RDS MySQL primary instance and Read-Only instance. | RDS MySQL | [:clapper:](https://www.youtube.com/watch?v=BgDO3DvEo1g) | |
